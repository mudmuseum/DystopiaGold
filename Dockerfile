...
RUN apt update
RUN apt install gcc libcrypt1-dev libcrypt1 libcryptsetup-dev libcryptsetup12 libxcrypt-source zlib1g-dev zlib1g zlibc make gcc-aarch64-linux-gnu binutils-aarch64-linux-gnu -y
