	    ...
	    && cmd_table[cmd].discipline == 0)
	{
		...
		switch (ch->class)
		{
		    ...
		    case 256:sprintf(buf, " %15s : ", "Lich Abilities");break;
                    ...
                    case 131072:sprintf(buf, " %15s : ", "Lizadary");break;
                    case 262144:sprintf(buf, " %15s : ", "Giant Powers");break;
		}
	    }
	    else if (i % 4 == 0)
	    {
...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "upgrade",        do_upgrade,     POS_STANDING,    3, LOG_SEMI,0,0,0},
    ...
    { "itemwearfind",   do_itemwearfind, POS_DEAD, 12, LOG_NORMAL, 0, 0, 0},
    ...
    { "selfclass",     do_classself,  POS_STANDING,      3,  LOG_SEMI, 0,0,0},
    ...
    { "reform",         do_reform,           POS_FIGHTING, 3, LOG_NORMAL, 16, 0, 0 },
    { "ancestralpath",  do_classportal,      POS_STANDING, 3, LOG_NORMAL, 16, 0, 0 },
   ...
   /* Demon pray - yep, kinda needed it here for some reason, damn tables. */
    ...
    { "pray",           do_pray,        POS_MEDITATING,  1,  LOG_NORMAL, CLASS_DEMON,0,0 },

    /* Giant powers */

    { "truesight",    do_truesight,     POS_STANDING,   3,  LOG_NORMAL, CLASS_GIANT,0,0},
    { "longstep",     do_classportal,   POS_STANDING,   3,  LOG_NORMAL, CLASS_GIANT,0,0},
    ...
    { "tunnel",       do_classportal,   POS_STANDING,   3,  LOG_NORMAL, 32768,0,0},
    ...
    { "callgolems",   do_callgolems,    POS_FIGHTING,   3,  LOG_NORMAL, 256,0,0},

    /*
     * Drone powers
     */

    { "abstract",     do_abstract,      POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "dronearmor",   do_dronearmor,    POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0 ,0},
    { "dreamscape",   do_classportal,   POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "drool",        do_drool,         POS_DEAD,       3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "truesight",    do_truesight,     POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "shield",       do_shield,        POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "mentalblock",  do_mentalblock,   POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "readaura",     do_readaura,      POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "mindwarp",     do_mindwarp,      POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "realityshift", do_realityshift,  POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "psionicburst", do_psionicburst,  POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "mindseye",     do_mindseye,      POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "distort",      do_distort,       POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "horrid",       do_horrid,        POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "nightmare",    do_nightmare,     POS_STANDING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    { "memorytwist",  do_memorytwist,   POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DRONE, 0, 0},
    ...
    { "barkshift",    do_classportal,   POS_STANDING,   3,  LOG_NORMAL,65536,DISC_FAE_NATURE,6},
    ...
    { "chaosgate",	do_classportal,	POS_STANDING, 3, LOG_NORMAL, 1024,0,0},
    ...
    { "ride",		do_classportal,	POS_STANDING, 3, LOG_NORMAL, 4096,0,0},
    ...
    { "swoop",         do_classportal,   POS_STANDING,  3, LOG_NORMAL, 2048,0,0 },
    ...
    { "mistwalk",    do_classportal,  POS_STANDING,  3,  LOG_NORMAL, 512,0,0 },
    ...
    { "teleport",     do_classportal,  POS_STANDING,   3,  LOG_NORMAL, 2,0,0 },
...
// Auspex
    ...
    { "astralwalk",	do_classportal,POS_STANDING,  3,  LOG_NORMAL, 8, DISC_VAMP_AUSP, 4 },
...
/* need it before forge */
  ...
  */
    ...
    { "celestial",	do_classportal,POS_STANDING,	 3,  LOG_NORMAL, 64,0,0 },
...
// Metis
   ...
   /* Luna Powers */
    ...
    { "moongate",	do_classportal,POS_STANDING,      3,  LOG_NORMAL, 4,DISC_WERE_LUNA,6 },
   /* No more luna Powers */
...
/* Vamp ^^^^ */
    ...
    { "cursed",         do_cursed,      POS_STANDING,    2,  LOG_NORMAL, 0,0,0},
    ...
    { "miktalk",        do_miktalk,       POS_DEAD,      3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "ninjaarmor",     do_ninjaarmor,    POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "nfocus",         do_nfocus,        POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "moonstrike",     do_moonstrike,    POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "shadowthrust",   do_shadowthrust,  POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "dirtthrow",      do_dirtthrow,     POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "gutcutter",      do_gutcutter,     POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "soulreaper",     do_soulreaper,    POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "knifespin",      do_knifespin,     POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "wakasashislice", do_wakasashislice,POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "caltrops",       do_caltrops,      POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "vanish",         do_vanish,        POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "shadowwalk",     do_classportal,   POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "truesight",      do_truesight,     POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "shadowlearn",    do_shadowlearn,   POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "assassinate",    do_assassinate,   POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "soulseek",       do_soulseek,      POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "soultarget",     do_soultarget,    POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "shield",         do_shield,        POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "scry",           do_scry,          POS_STANDING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },
    { "mienaku",        do_mienaku,       POS_FIGHTING,  3,  LOG_NORMAL, CLASS_NINJA, 0, 0 },

    /*start drow section */

    { "dktalk",		do_dktalk,	POS_DEAD,	1, LOG_NORMAL, 0,0,0},
    { "newbie",		do_newbie,	POS_DEAD,	1, LOG_NORMAL,0,0,0},
    { "newbiehint",     do_newbiehint,  POS_DEAD,       1, LOG_NORMAL ,0,0,0},
    ...
    { "shadowwalk",	do_classportal,	POS_STANDING,    3,  LOG_NORMAL, 32,0,0 },
    { "drowcreate",    	do_drowcreate,	POS_STANDING,    3,  LOG_NORMAL, 32,0,0 },
    { "heal",		do_heal,	POS_STANDING,    3,  LOG_NORMAL, 32,0,0 },
...
/*demon section*/
    ...
    { "travel",		do_classportal,	POS_STANDING,	 3,  LOG_NORMAL, 1,0,0 },
...
/* vamp protean healing*/
    ...
    { "chitter",        do_chitter,       POS_DEAD,       3,  LOG_NORMAL, 8192, 0, 0 },
    { "web",            do_web,           POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "spiderarmor",    do_spiderarmor,   POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "lloth",          do_lloth,         POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "shadowwalk",     do_classportal,   POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "darkness",       do_darkness,      POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "radarscan",      do_radarscan,     POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "truesight",      do_truesight,     POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "battlestation",  do_battlestation, POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "implant",        do_implant,       POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "reload",         do_reload,        POS_STANDING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "droidspeed",     do_droidspeed,    POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "submachine",     do_submachine,    POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "rocketblast",    do_rocketblast,   POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },
    { "steam",          do_steam,         POS_FIGHTING,   3,  LOG_NORMAL, 8192, 0, 0 },

    { "createbase",   do_createbase,  POS_DEAD,    12, LOG_NORMAL, 0, 0, 0},
    { "showquest",    do_showquest,   POS_DEAD,     2, LOG_NORMAL, 0, 0, 0},
    { "qgain",        do_qgain,       POS_STANDING, 2, LOG_NORMAL, 0, 0, 0},
    { "qcomplete",    do_qcomplete,   POS_STANDING, 2, LOG_NORMAL, 0, 0, 0},

    { "shop",         do_shop,        POS_STANDING, 2, LOG_NORMAL, 0, 0, 0},
     ...
     * Immortal commands.
     */
    { "faith",          do_faith,       POS_DEAD,               12,   LOG_NORMAL,0,0,0},
    ...
    { "trusted",        do_trusted,      POS_DEAD,              12,  LOG_NORMAL,0,0,0},
    { "aggrocheck",     do_aggrocheck,   POS_DEAD,              12,  LOG_NORMAL, 0,0,0},
...
//    { "oswitch",		do_oswitch,	POS_DEAD,	 	 8,  LOG_NORMAL, 0,0,0},
    ...
    { "address", do_address, POS_DEAD, 1, LOG_NORMAL, 0, 0, 0},
...
found = TRUE;
	...
	if (!IS_CREATOR(ch) && !IS_NPC(ch))
	{
          ...
          {
            ch->pcdata->log_count--;
            if (ch->pcdata->log_count == 0) REMOVE_BIT(ch->act, PLR_LOG);
          }
  ...
  if (extra_log)
  {
    if (cPerm < sAllocPerm)
    {
      sprintf(buf, "Alloc_perm : %s %s by %s",
