...
Tender who?
none
You tenderly kiss $n on the mouth.
$n tenderly kisses $N on the mouth.
$n tenderly kisses you on the mouth.
Tender yourself? how?
none
 
nibble
You nibble your lower lip.
$n is nibbling $s lower lip.
You softly nibble $n's earlobe.
$n is nibbling $N's earlobe.
$n softly nibbles your earlobe.
How can you nibble  your own earlobe?
$n is attempting to nibble $s own ear...how sad.
 
caress
You caress the side of your cheek thoughtfully.
$n caresses $s cheek thoughtfully.
You caress $n's forearm softly.
$n is softly caressing $N's forearm.
$n softly caresses your forearm.
You caress your arms in confusion.
$n is caressing $s arms in confusion.
 
stroke
Stroke who?
none
You teasingly stroke $n's thigh.
$n is teasingly stroking $N's thigh.
$n strokes your thigh teasingly.
You stroke yourself?
$n is stroking $s own thigh!
 
squeal
You squeal delightedly!
$n delightedly squeals!
You squeal with delight at $n.
$n squeals delightedly at $N.
$n squeals with delight at you.
You squeal delightedly!
$n delightedly squeals!
...
Pat who?
none
You pat $n on the head good naturedly.
$n is patting $N good naturedly on the head.
$n good naturedly pats you on your head.
You pat yourself on the back.
$n is patting $mself on the back.
 
que
A question mark appears over your head.
A question mark appears over $n's head.
You look at $n questioningly.
$n is questioningly looking at $N.
$n looks at you questioningly.
A question mark appears over your head.
A question mark appears over $n's head.
 
eblink
You blink your eyes.
$n is blinking $s eyes.
You blink at $n innocently.
$n is blinking at $N innocently.
$n blinks at you innocently.
Do you have something in your eye?
$n is blinking...must have something in $s eye.
 
innocent
A halo appears over you with horns peaking up from your head.
A halo appears over $n, but you can see the horns peaking up from $s head.
You exclaim "I'm innocent!" with a devilish giggle to $n.
$n exclaims "I'm innocent!" to $N , devilishly giggling.
With a devilish giggle, $n exclaims to you "I'm innocent!"
You exclaim "I'm innocent!" as a devilish giggle escapes your mouth.
$n is exclaiming "I'm innocent!" as a devilish giggle escapes $s mouth.

Add them soon mr. Jobo
...
const	struct	social_type	social_table [] =
{
...

  {
    ...
    "WOO! WOO!",
    "$n exclaims WOO! WOO!",
    "You cheer WOO! WOO! Way to go $n!",
    "$n is cheering WOO! WOO! Way to go! at $N.",
    "$n cheers you with WOO! WOO! Way to go!",
    "WOO! WOO!",
    "$n exclaims WOO! WOO!"
  },
  ...
  {
    "flop",
    "You flop around on the ground like a helpless fish out of water.",
    "$n flops around helplessly.",
    "You flop yourself into $N. *flop*",
    "$n helplessly flops into $N.",
    "$n limply flops into you.",
    "You try in vain to figure out how you can flop into yourself.",
    NULL
  },
...

  {
    ...
    "$n grins at $N.",
    "$n grins at you.",
    "You grin at yourself. Hmmm, you're almost as strange as Sephira.",
    "$n grins at $mself."
  },
  ...
  {
    "mmm",
    "You lick your lips and go mMmMmm.",
    "$n smacks $s lips and goes mMmmMm.",
    "You look $M over, lick your lips, and go MmmMm.",
    "You catch $n peering at $N and licking $s lips.",
    "$n casts a devilish grin towards you and goes mmmMmmMmm.",
    "You're such sexy of piece of meat, you can't help thinking about how tasty you are!",
    "$n looks $mself up and down and goes MmmMmmm."
  },
  ...
  {
    "poke",
    "You furiously prod the air.",
    "$n pokes $s imaginary friend.",
    "You poke $M in the ribs.",
    "$n pokes $N in the ribs.",
    "$n pokes you in the ribs.",
    "You poke your eye out. Ow!",
    "$n pokes $mself in the eye."
  },


  {
    "rawr",
    "You throw your head back and RaaaAaWwR!",
    "$n RaaAAwwrs at the top of $s lungs!",
    "You fiercely rAaaAWWwrR at $N.",
    "$n rraaaAwWrRs at $N like the beast $e is.",
    "$n RrrAaaaWwwRrs at you! The HORROR!",
    "Infuriated, you work yourself up and RaaAaawwWr at your foolishness.",
    "A perturbed $N rrAaawwRrs at $mself.."
  },
...

  {
    ...
    "You sniff sadly.",
    "$n sniffs sadly.",
    "You put on your best puppy dog face and sadly sniff at $N.",
    "$n sadly sniffs at $N with puppy dog eyes.",
    "A puppy-eyed $n sadly sniffs at you.",
    "You sniff yourself. Smells like cheese.",
    "$n sniffs $s armpits."
  },

  {
    ...
    "$n snickers at $N.",
    "$n snickers at you.",
    "You eat a Snickers bar. Yum!",
    "$n whips out a Snickers candy bar and chomps it. Looks tasty!"
  },

  {
    "smooch",
    "You pucker your lips and make a 'SMOOCH' sound.",
    "$n puckers $s lips and goes 'SMOOCH'.",
    "You smooch $m passionately.",
    "$n smooches $N.",
    "$n gives you a passionate smooch.",
    "You raise your hand to your mouth and smooch it.",
    "$n smooches the back of $s hand."
  },
  ...
  {
    "whap",
    "You swing your hand through the air and say 'whap!'",
    "$n swings $s hand through the air and says 'whap!'",
    "You take the back of your hand and 'whap' the back of $n's head.",
    "$n 'whaps' the back of $N's head.",
    "$n 'whaps' the back of your head.",
    "You 'whap' the side of your head.",
    "$n 'whaps' $mself on the side of $s head."
  },

  {
    ...
    "$n winces at $N.",
    "$n winces at you.",
    "You wince at your gaping wounds.  Arggghh!",
    "$n winces at $s gaping wounds.  Ouch!"
    },
    ...
    "You wink at yourself, ya freak.",
    "$n winks at $mself, evidently conspiring with one of $s alternate personalities."
    },

    {
    "wrap",
    "You peer at the air, wondering how you can wrap it.",
    NULL,
    "You wrap your legs around $M and squish.",
    "$n wraps $s legs around $N.",
    "$n wraps $s legs around you and squishes you mercilessly.  Wonder what's coming next?",
